...
- [x] **Step 2: 验证前端源文件无旧的可见品牌文案**

Run: `rg -n "好基灵|FundPilot" apps/web/src -g '!*.test.ts' -g '!*.test.tsx'`

Expected: 无匹配。`fundpilot-*` 小写内部兼容键允许继续存在。

- [x] **Step 3: 运行品牌测试和全量单元测试**
