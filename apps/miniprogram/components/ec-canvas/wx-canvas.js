/**
 * wx-canvas.js — 官方 ec-canvas 的画布适配层。
 * 将微信小程序 Canvas（2d / 旧版 canvas-id）封装为 echarts 可用的画布对象，
 * 提供 setChart / attachEvent / getContext 等接口，供 echarts.setCanvasCreator 使用。
 * 来源：echarts-for-weixin 官方组件，保持与官方实现一致。
 */
